!function () {
    ...
    var a = {android: navigator.userAgent.toLowerCase().indexOf("android") > -1}, b = function (a, b, c) {
    ...
    }, m = {tap: {touches: 1, taps: 1}, dbltap: {touches: 1, taps: 2}, contextmenu: {touches: 2, taps: 1}}, n = function (a, b) {
        return function (c, f, g, h) {
            if ("contextmenu" == f && r)k(c, f, g, h); else {
                if (null == c.__taTapHandler) {
                    var i = c.__taTapHandler = {tap: [], dbltap: [], contextmenu: [], down: !1, taps: 0}, j = function () {
                        i.down = !0, setTimeout(n, a), setTimeout(o, b)
                    }, l = function (a) {
                        if (i.down) {
                            i.taps++;
                            var b = B(a);
                            for (var c in m) {
                                var e = m[c];
                                if (e.touches === b && (1 === e.taps || e.taps === i.taps))for (var f = 0; f < i[c].length; f++)i[c][f].apply(d(a), [a])
                            }
                        }
                    }, n = function () {
                        i.down = !1
                    ...
                    k(c, "mousedown", j, h), k(c, "mouseup", l, h)
                }
                c.__taTapHandler[f].push(g), g.__taUnstore = function () {
                    e(c.__taTapHandler[f], g)
                }
            }
        }
    }, o = function (a, b, c, d) {
    ...
    }, q = "ontouchstart"in document.documentElement, r = "onmousedown"in document.documentElement, s = {mousedown: "touchstart", mouseup: "touchend", mousemove: "touchmove"}, t = function () {
        var a = -1;
        ...
        null != d && E(a, function () {
            var a = c(this);
            if (h(a, b, d), null != d.__tauid)if (a.removeEventListener)a.removeEventListener(b, d, !1); else if (this.detachEvent) {
                var e = b + d.__tauid;
    ...
    this.Mottle = function (b) {
        ...
        this.remove = function (a) {
            ...
            return E(b, function () {
                var b, k = c(this);
                e = e || {screenX: i[0], screenY: i[1], clientX: j[0], clientY: j[1]};
                var l = function (a) {
                    f && (a.payload = f)
                ...
                if (document.createEvent) {
                    var n = q && s[d] && !a.android, o = n ? "MouseEvents" : "MouseEvents";
    ...
    var a = function (a) {
        ...
        return a.touches && a.touches.length > 0 ? a.touches : a.changedTouches && a.changedTouches.length > 0 ? a.changedTouches : a.targetTouches && a.targetTouches.length > 0 ? a.targetTouches : [a]
    }, h = {draggable: "katavorio-draggable", droppable: "katavorio-droppable", drag: "katavorio-drag", selected: "katavorio-drag-selected", active: "katavorio-drag-active", hover: "katavorio-drag-hover", noSelect: "katavorio-drag-no-select"}, i = "katavorio-drag-scope", j = ["stop", "start", "drag", "drop", "over", "out"], k = function () {
    }, l = function () {
        return!0
    }, m = function (a, b, c) {
        ...
        b.addClass(a, this._class), this.el = a;
        var e = !0;
        ...
        var g, h = s.apply(this, arguments), i = [0, 0], j = null, k = !1, m = d.consumeStartEvent !== !1, o = c, q = d.clone, t = function (a) {
            return null == d.grid ? a : [d.grid[0] * Math.floor(a[0] / d.grid[0]), d.grid[1] * Math.floor(a[1] / d.grid[1])]
        }, u = d.constrain || d.containment ? function (a) {
            return{x: a[0], y: a[1], w: this.size[0], h: this.size[1]}, [Math.max(0, Math.min(g.w - this.size[0], a[0])), Math.max(0, Math.min(g.h - this.size[1], a[1]))]
        }.bind(this) : function (a) {
            return a
        }, v = l, w = this.setFilter = function (a) {
            a && (v = function (d) {
                var e = d.srcElement || d.target;
                return!b(e, a, c)
            })
        }, x = d.canDrag || l, y = [], z = [], A = function (b) {
            if (this.isEnabled() && x()) {
                var g = v(b) && r(b, c, this.k);
                if (g) {
                    if (q) {
                        o = c.cloneNode(!0), o.setAttribute("id", null), o.style.position = "absolute";
                        var k = a(c);
                        o.style.left = k.left + "px", o.style.top = k.top + "px", document.body.appendChild(o)
                    } else o = c;
                    m && p(b), i = e(b), d.events.start({el: c, pos: j, e: b, drag: this}), d.bind(document, "mousemove", B), d.bind(document, "mouseup", C), h.markSelection(this), d.addClass(document.body, f.noSelect)
                } else d.consumeFilteredEvents && p(b)
            }
        }.bind(this), B = function (a) {
            if (i) {
                k || (this.mark(), k = !0), z.length = 0;
                var b = e(a), c = b[0] - i[0], f = b[1] - i[1], g = d.ignoreZoom ? 1 : h.getZoom();
                c /= g, f /= g, this.moveBy(c, f, a), h.updateSelection(c, f, this)
            }
        }.bind(this), C = function (a) {
            i = null, k = !1, d.unbind(document, "mousemove", B), d.unbind(document, "mouseup", C), d.removeClass(document.body, f.noSelect), this.unmark(a), h.unmarkSelection(this, a), d.events.stop({el: o, pos: d.getPosition(o), e: a, drag: this}), q && (o && o.parentNode && o.parentNode.removeChild(o), o = null)
        }.bind(this);
        this.abort = function () {
            null != i && C()
            ...
            if (j = d.getPosition(o), this.size = d.getSize(o), y = h.getMatchingDroppables(this), n(y, !0, !1, this), d.addClass(o, d.dragClass || f.drag), d.constrain || d.containment) {
                var a = d.getSize(o.parentNode);
                g = {w: a[0], h: a[1]}
            }
        }, this.unmark = function (a) {
            n(y, !1, !0, this), y.length = 0;
            for (var b = 0; b < z.length; b++)z[b].drop(this, a);
            d.removeClass(o, d.dragClass || f.drag)
        }, this.moveBy = function (a, b, e) {
            z.length = 0;
            var f = u(t([j[0] + a, j[1] + b])), g = {x: f[0], y: f[1], w: this.size[0], h: this.size[1]};
            d.setPosition(o, f);
            for (var h = 0; h < y.length; h++) {
                var i = {x: y[h].position[0], y: y[h].position[1], w: y[h].size[0], h: y[h].size[1]};
                d.intersects(g, i) && y[h].canDrop(this) ? (z.push(y[h]), y[h].setHover(this, !0, e)) : y[h].el._katavorioDragHover && y[h].setHover(this, !1, e)
            }
            d.events.drag({el: c, pos: f, e: e, drag: this})
        }, this.destroy = function () {
            d.unbind(c, "mousedown", A)
        }, d.bind(c, "mousedown", A), w(d.filter)
    }, u = function (a, b, c) {
        this._class = c.droppable, this._activeClass = b.activeClass || c.active, this._hoverClass = b.hoverClass || c.hover;
        var d = (s.apply(this, arguments), !1);
        this.setActive = function (c) {
            b[c ? "addClass" : "removeClass"](a, this._activeClass)
        }, this.updatePosition = function () {
            this.position = b.getPosition(a), this.size = b.getSize(a)
        }, this.canDrop = b.canDrop || function () {
            return!0
        }, this.setHover = function (c, e, f) {
            (e || null == a._katavorioDragHover || a._katavorioDragHover == c.el._katavorio) && (b[e ? "addClass" : "removeClass"](a, this._hoverClass), a._katavorioDragHover = e ? c.el._katavorio : null, d !== e && b.events[e ? "over" : "out"]({el: a, e: f, drag: c, drop: this}), d = e)
        }, this.drop = function (a, c) {
            b.events.drop({drag: a, e: c, drop: this})
        }, this.destroy = function () {
        }
    }, v = function () {
    ...
    this.Katavorio = function (a) {
        var b = [], c = {}, d = {}, e = {}, f = 1, g = function (a, b) {
            for (var c = 0; c < a.scopes.length; c++)b[a.scopes[c]] = b[a.scopes[c]] || [], b[a.scopes[c]].push(a)
        }, l = function (b, c) {
            for (var d = 0; d < b.scopes.length; d++)if (c[b.scopes[d]]) {
                var e = a.indexOf(c[b.scopes[d]], b);
                -1 != e && c[b.scopes[d]].splice(e, 1)
            }
        }, n = (this.getMatchingDroppables = function (a) {
            for (var b = [], c = {}, d = 0; d < a.scopes.length; d++) {
                var f = e[a.scopes[d]];
                if (f)for (var g = 0; g < f.length; g++)f[g].canDrop(a) && !c[f[g].el._katavorio] && f[g].el !== a.el && (c[f[g].el._katavorio] = !0, b.push(f[g]))
            }
            return b
        }, function (b) {
            b = b || {};
            ...
            for (var d = 0; d < j.length; d++)c.events[j[d]] = b[j[d]] || k;
            return c.katavorio = this, c
        }.bind(this)), p = {}, r = a.css || {}, s = a.scope || i;
        for (var v in h)p[v] = h[v];
        for (var v in r)p[v] = r[v];
        var x = a.inputFilterSelector || q;
        this.getInputFilterSelector = function () {
            ...
            return o(a, function () {
                ...
                if (null != a) {
                    var e = n(b);
                    a._katavorioDrag = new t(a, e, p, s), g(a._katavorioDrag, d), c.push(a._katavorioDrag)
                }
            }), c
            ...
            return o(a, function () {
                var a = w(this);
                null != a && (a._katavorioDrop = new u(a, n(b), p, s), g(a._katavorioDrop, e), c.push(a._katavorioDrop))
            }), c
        }, this.select = function (d) {
            return o(d, function () {
                var d = w(this);
                d && d._katavorioDrag && (c[d._katavorio] || (b.push(d._katavorioDrag), c[d._katavorio] = [d, b.length - 1], a.addClass(d, p.selected)))
            }), this
            ...
            return o(d, function () {
                ...
                if (d && d._katavorio) {
                    ...
                    if (e) {
                        ...
                        b = f, delete c[d._katavorio], a.removeClass(d, p.selected)
                    }
                }
            }), this
        ...
        var y = function (a, b, c) {
            null != a && (l(a, c), a.setScope(b), g(a, c))
        };
        this.setScope = function (a, b) {
            y(a._katavorioDrag, b, d), y(a._katavorioDrop, b, e)
        }, this.setDragScope = function (a, b) {
            y(a._katavorioDrag, b, d)
        }, this.setDropScope = function (a, b) {
            y(a._katavorioDrop, b, e)
    ...
    }, ieVersion: /MSIE\s([\d.]+)/.test(navigator.userAgent) ? new Number(RegExp.$1) : -1}, jsPlumbUtil.oldIE = jsPlumbUtil.ieVersion > -1 && jsPlumbUtil.ieVersion < 9, jsPlumbUtil.EventGenerator = function () {
        var a = {}, b = !1, c = {ready: !0};
        ...
        this.register = function (g) {
            ...
            for (e[h] = e[h] ? e[h] + 1 : 1; null != j && j != g;) {
                ...
                if (k && b[k]) {
                    ...
                    null == d[k][h] && (d[k][h] = {id: h, offset: {left: i.left - l.left, top: i.top - l.top}}, f[h] = k);
                    break
                }
                j = j.parentNode
            }
    ...
    window.jsPlumbAdapter = {headless: !1, pageLocation: f, screenLocation: g, clientLocation: h, getAttribute: function (a, b) {
    ...
    }, e = ["click", "dblclick", "mouseenter", "mouseout", "mousemove", "mousedown", "mouseup", "contextmenu"], f = {mouseout: "mouseleave", mouseexit: "mouseleave"}, g = function (a, b, c, d) {
    ...
    jsPlumbUtil.extend(j, jsPlumbUtil.EventGenerator, {getParameter: function (a) {
        ...
        if (this._jsPlumb && !this._jsPlumb.instance.currentlyDragging && !this._jsPlumb.instance.isHoverSuspended()) {
            ...
            null != this._jsPlumb.hoverPaintStyle && (this._jsPlumb.paintStyleInUse = a ? this._jsPlumb.hoverPaintStyle : this._jsPlumb.paintStyle, this._jsPlumb.instance.isSuspendDrawing() || (d = d || c(), this.repaint({timestamp: d, recalc: !1}))), this.getAttachedElements && !b && g(this, a, c(), this)
        }
    }});
    var k = "__label", l = function (a, b) {
        ...
        } else d = c.constructor == String ? new (t.Overlays[b._jsPlumb.instance.getRenderMode()][c])({component: b, _jsPlumb: b._jsPlumb.instance}) : c;
    ...
    jsPlumbUtil.extend(p, j, {applyType: function (a, b) {
    ...
    var q = 0, r = function () {
        ...
        var n = null, o = !1, p = [], q = {}, s = {}, u = {}, v = {}, w = {}, x = {}, y = !1, z = [], A = !1, B = null, C = this.Defaults.Scope, D = null, E = 1, F = function () {
            ...
            if (!jsPlumbAdapter.headless && !A) {
                ...
                if (h)for (var j in h)W({elId: h[j].id, offset: {left: i.o.left + h[j].offset.left, top: i.o.top + h[j].offset.top}, recalc: !1, timestamp: d});
            ...
            if (b = b || {}, a.suspendedEndpoint || p.push(a), (null == a.suspendedEndpoint || d) && e.anchorManager.newConnection(a), I(a.source), !b.doNotFireConnectionEvent && b.fireEvent !== !1) {
                var f = {connection: a, source: a.source, target: a.target, sourceId: a.sourceId, targetId: a.targetId, sourceEndpoint: a.endpoints[0], targetEndpoint: a.endpoints[1]};
            ...
            return A && !d && (d = B), !f && d && d === v[h] ? {o: a.offset || u[h], s: z[h]} : (f || !g ? (c = document.getElementById(h), null != c && (z[h] = e.getSize(c), u[h] = b(c, e), v[h] = d)) : (u[h] = g, null == z[h] && (c = document.getElementById(h), null != c && (z[h] = e.getSize(c))), v[h] = d), u[h] && !u[h].right && (u[h].right = u[h].left + z[h][0], u[h].bottom = u[h].top + z[h][1], u[h].width = z[h][0], u[h].height = z[h][1], u[h].centerx = u[h].left + u[h].width / 2, u[h].centery = u[h].top + u[h].height / 2), {o: u[h], s: z[h]})
        }, X = function (a) {
            var b = u[a];
        ...
        this.setConnectionBeingDragged = function (a) {
            ...
            for (var g = [], h = a.isArray(b) || null != b.length && !a.isString(b) ? b : [b], i = 0, j = h.length; j > i; i++) {
                ...
                var n = u[l], o = z[l], p = m.anchor.compute({xy: [n.left, n.top], wh: o, element: m, timestamp: B}), r = {anchorLoc: p, timestamp: B};
        ...
        var Z = [
            ...
            var e, f, g, h = Z[c], i = a[h.elId], j = (a[h.el], a.endpoints[c]), k = {index: c, originalSourceId: 0 === c ? i : a.sourceId, newSourceId: a.sourceId, originalTargetId: 1 == c ? i : a.targetId, newTargetId: a.targetId, connection: a};
        ...
        var _ = function (a, b, c) {
            var d = e.Defaults.ConnectionType || e.getDefaultConnectionType(), f = a.constructor == d, g = f ? {connection: a, source: a.source, target: a.target, sourceId: a.sourceId, targetId: a.targetId, sourceEndpoint: a.endpoints[0], targetEndpoint: a.endpoints[1]} : a;
        ...
        this.unregisterEndpoint = function (a) {
            ...
            var b = {endpoints: {}, connections: {}, endpointCount: 0, connectionCount: 0}, c = a.fireEvent !== !1, d = a.deleteAttachedObjects !== !1, f = function (a) {
        ...
        var hb = function (a, b) {
            ...
            var b = jb(a, kb);
            return t.extend(b, {setDetachable: db(a, "setDetachable", kb), setReattach: db(a, "setReattach", kb), setConnector: db(a, "setConnector", kb), detach: function () {
                for (var b = 0, c = a.length; c > b; b++)e.detach(a[b])
            }, isDetachable: eb(a, "isDetachable"), isReattach: eb(a, "isReattach")})
        }, lb = function (a) {
            var b = jb(a, lb);
            return t.extend(b, {setEnabled: db(a, "setEnabled", lb), setAnchor: db(a, "setAnchor", lb), isEnabled: eb(a, "isEnabled"), detachAll: function () {
        ...
        this.init = function () {
            ...
            if ("string" == typeof d)h = c(arguments[0], {elementId: f, jsPlumbInstance: e}); else if (a.isArray(d))if (a.isArray(d[0]) || a.isString(d[0]))2 == d.length && a.isObject(d[1]) ? a.isString(d[0]) ? (b = t.extend({elementId: f, jsPlumbInstance: e}, d[1]), h = c(d[0], b)) : (b = t.extend({elementId: f, jsPlumbInstance: e, anchors: d[0]}, d[1]), h = new t.DynamicAnchor(b)) : h = new t.DynamicAnchor({anchors: d, selector: null, elementId: f, jsPlumbInstance: g}); else {
                var i = {x: d[0], y: d[1], orientation: d.length >= 4 ? [d[2], d[3]] : [0, 0], offsets: d.length >= 6 ? [d[4], d[5]] : [0, 0], elementId: f, jsPlumbInstance: g, cssClass: 7 == d.length ? d[6] : null};
        ...
        this.makeTarget = function (c, d, f) {
            ...
            var h = g.scope || e.Defaults.Scope, i = !(g.deleteEndpointsOnDetach === !1), l = g.maxConnections || -1, m = g.onMaxConnections, n = function (c) {
                ...
                qb(e), this.targetEndpointDefinitions[e] = {def: g, uniqueEndpoint: g.uniqueEndpoint, maxConnections: l, enabled: !0};
                var o = function () {
                    ...
                    if (!p.enabled || p.maxConnections > 0 && c >= p.maxConnections)return m && m({element: d.el, connection: l}, a), !1;
                    ...
                    if (l.suspendedEndpoint) {
                        ...
                        ab({index: n, originalSourceId: 0 === n ? r : l.sourceId, newSourceId: 0 === n ? e : l.sourceId, originalTargetId: 1 == n ? r : l.targetId, newTargetId: 1 == n ? e : l.targetId, connection: l}, a)
                    }
                    if (q) {
            ...
            var h = g.maxConnections || -1, j = g.onMaxConnections, l = function (c) {
                ...
                qb(n), this.sourceEndpointDefinitions[n] = {def: g, uniqueEndpoint: g.uniqueEndpoint, maxConnections: h, enabled: !0};
                ...
                q.scope = q.scope || g.scope, q[p] = a.wrap(q[p], function () {
                    ...
                    if (s && s.apply(this, arguments), this.currentlyDragging = !1, null != u._jsPlumb) {
                        ...
                        if (null != f.positionFinder) {
                            var i = b(h, this), j = this.getSize(h), k = {left: i.left + c.x * j[0], top: i.top + c.y * j[1]}, n = f.positionFinder(k, i, j, f.constructorParams);
                            f.x = n[0], f.y = n[1]
                        }
                ...
                var w = function (a) {
                    ...
                    if (d = this.getId(this.getDOMElement(f)), c.enabled) {
                        ...
                        if (c.maxConnections >= 0 && o >= c.maxConnections)return j && j({element: f, maxConnections: h}, a), !1;
    ...
    jsPlumb.Endpoint = function (g) {
        ...
        g._transient || this._jsPlumb.instance.anchorManager.add(this, this.elementId), this.setEndpoint = function (a) {
            ...
            }, c = {_jsPlumb: this._jsPlumb.instance, cssClass: g.cssClass, container: g.container, tooltip: g.tooltip, connectorTooltip: g.connectorTooltip, endpoint: this};
            ...
            b = null == b ? f(a, this) : b, b >= 0 && (this.connections.splice(b, 1), this[(this.connections.length > 0 ? "add" : "remove") + "Class"](h.endpointConnectedClass), this[(this.isFull() ? "add" : "remove") + "Class"](h.endpointFullClass)), !c && this._deleteOnDetach && 0 === this.connections.length && h.deleteObject({endpoint: this, fireEvent: !1, deleteAttachedObjects: !1})
        }, this.detach = function (a, b, c, d, e, g, i) {
            var j = null == i ? f(a, this) : i, k = !1;
            return d = d !== !1, j >= 0 && (c || a._forceDetach || a.isDetachable() && a.isDetachAllowed(a) && this.isDetachAllowed(a)) && (h.deleteObject({connection: a, fireEvent: !b && d, originalEvent: e, deleteAttachedObjects: !1}), k = !0), k
            ...
            return l({dropOptions: g.dropOptions, anchor: d, source: this.element, paintStyle: this.getPaintStyle(), endpoint: g.hideOnDrag ? "Blank" : this.endpoint, _transient: !0, scope: this.scope})
            ...
            if ((this.isTarget || b) && jsPlumb.isDropSupported(this.element)) {
                ...
                var f = jsPlumb.dragEvents.drop, i = jsPlumb.dragEvents.over, k = jsPlumb.dragEvents.out, l = function () {
                    ...
                    if (null != f) {
                        ...
                        if (this.isFull() && this.fire("maxConnections", {endpoint: this, connection: f, maxConnections: this._jsPlumb.maxConnections}, a), !this.isFull() && (0 !== i || this.isSource) && (1 != i || this.isTarget) && j) {
                            var k = !0;
    ...
    jsPlumb.Connection = function (a) {
        ...
        this._jsPlumb.visible = !0, this._jsPlumb.editable = a.editable === !0, this._jsPlumb.params = {cssClass: a.cssClass, container: a.container, "pointer-events": a["pointer-events"], editorParams: a.editorParams}, this._jsPlumb.lastPaintedAt = null, this.getDefaultType = function () {
        ...
        if (d.updateOffset({elId: this.sourceId, timestamp: g}), d.updateOffset({elId: this.targetId, timestamp: g}), !d.isSuspendDrawing()) {
            var h = d.getCachedData(this.sourceId), i = h.o, j = h.s, k = d.getCachedData(this.targetId), l = k.o, m = k.s, n = g || d.timestamp(), o = this.endpoints[0].anchor.compute({xy: [i.left, i.top], wh: j, element: this.endpoints[0], elementId: this.endpoints[0].elementId, txy: [l.left, l.top], twh: m, tElement: this.endpoints[1], timestamp: n});
            this.endpoints[0].paint({anchorLoc: o, timestamp: n}), o = this.endpoints[1].anchor.compute({xy: [l.left, l.top], wh: m, element: this.endpoints[1], elementId: this.endpoints[1].elementId, txy: [i.left, i.top], twh: j, tElement: this.endpoints[0], timestamp: n}), this.endpoints[1].paint({anchorLoc: o, timestamp: n})
        }
        ...
        var e = {_jsPlumb: this._jsPlumb.instance, cssClass: this._jsPlumb.params.cssClass, container: this._jsPlumb.params.container, "pointer-events": this._jsPlumb.params["pointer-events"]}, f = this._jsPlumb.instance.getRenderMode();
        d.isString(b) ? this.connector = a(this._jsPlumb.instance, f, b, e) : d.isArray(b) && (this.connector = 1 == b.length ? a(this._jsPlumb.instance, f, b[0], e) : a(this._jsPlumb.instance, f, b[0], d.merge(b[1], e))), this.bindListeners(this.connector, this, function (a) {
            this.setHover(a, !1)
        }.bind(this)), this.canvas = this.connector.canvas, this.bgCanvas = this.connector.bgCanvas, this._jsPlumb.editable && null != jsPlumb.ConnectorEditors && jsPlumb.ConnectorEditors[this.connector.type] && this.connector.isEditable() ? new jsPlumb.ConnectorEditors[this.connector.type]({connector: this.connector, connection: this, params: this._jsPlumb.params.editorParams || {}}) : this._jsPlumb.editable = !1, c || this.repaint()
    }, paint: function (a) {
        ...
        if (e)d.endpoints[f] = e, e.addConnection(d); else {
            ...
            j = c({paintStyle: l, hoverPaintStyle: m, endpoint: k, connections: [d], uuid: o, anchor: n, source: h, scope: g.scope, reattach: g.reattach || a.Defaults.ReattachConnections, detachable: g.detachable || a.Defaults.ConnectionsDetachable}), d.endpoints[f] = j, g.drawEndpoints === !1 && j.setVisible(!1, !0, !0)
        }
        return j
    }})
}(), function () {
    jsPlumb.AnchorManager = function (a) {
        var b = {}, c = {}, d = {}, e = {}, f = {}, g = {HORIZONTAL: "horizontal", VERTICAL: "vertical", DIAGONAL: "diagonal", IDENTITY: "identity"}, h = {}, i = this, j = {}, k = a.jsPlumbInstance, l = {}, m = function (a, b, c, d, e, f) {
            ...
            return a[0] > b[0] ? 1 : -1
        }, right: o(!0), bottom: o(!0), left: p}, r = function (a, b) {
            return a.sort(b)
        }, s = function (a, b) {
        ...
        this.updateOtherEndpoint = function (a, b, c, d) {
            ...
            if (!k.isSuspendDrawing()) {
                ...
                for (v = 0; v < i.length; v++)0 === i[v].connections.length && i[v].anchor.isContinuous && (j[a] || (j[a] = {top: [], right: [], bottom: [], left: []}), u(j[a], -Math.PI / 2, 0, {endpoints: [i[v], i[v]], paint: function () {
                ...
                for (v = 0; v < n.length; v++) {
                    ...
                    if (H.anchor.constructor == jsPlumb.DynamicAnchor) {
                        H.paint({elementWithPrecedence: a, timestamp: d}), jsPlumbUtil.addWithFunction(o, n[v][0], function (a) {
    ...
    jsPlumb.DOMElementComponent = jsPlumbUtil.extend(jsPlumb.jsPlumbUIComponent, function () {
        ...
        var b, c, d, e, f, g, h, i = (jsPlumb.Segments.AbstractSegment.apply(this, arguments), function () {
            b = Math.sqrt(Math.pow(f - e, 2) + Math.pow(h - g, 2)), c = Biltong.gradient({x: e, y: g}, {x: f, y: h}), d = -1 / c
        });
    ...
    jsPlumbUtil.extend(c, jsPlumb.DOMElementComponent, {getDisplayElements: function () {
    ...
    }, jsPlumbUtil.extend(jsPlumb.Endpoints.Image, [c, jsPlumb.Endpoints.AbstractEndpoint], {cleanup: function () {
    ...
    }, jsPlumbUtil.extend(jsPlumb.Endpoints.Blank, [jsPlumb.Endpoints.AbstractEndpoint, c], {cleanup: function () {
    ...
    d.prototype = {cleanup: function () {
        ...
        this.computeMaxSize = function () {
            ...
            if (a.pointAlongPathFrom) {
                ...
                var q = {hxy: h, tail: k, cxy: l}, r = f.strokeStyle || d.strokeStyle, s = f.fillStyle || d.strokeStyle, t = f.lineWidth || d.lineWidth, u = {component: a, d: q, lineWidth: t, strokeStyle: r, fillStyle: s, minX: Math.min(h.x, k[0].x, k[1].x), maxX: Math.max(h.x, k[0].x, k[1].x), minY: Math.min(h.y, k[0].y, k[1].y), maxY: Math.max(h.y, k[0].y, k[1].y)};
                return u
            }
    ...
    jsPlumbUtil.extend(f, [jsPlumb.DOMElementComponent, d], {getDimensions: function () {
    ...
    "use strict";
    var a = {joinstyle: "stroke-linejoin", "stroke-linejoin": "stroke-linejoin", "stroke-dashoffset": "stroke-dashoffset", "stroke-linecap": "stroke-linecap"}, b = "stroke-dasharray", c = "dashstyle", d = "linearGradient", e = "radialGradient", f = "defs", g = "fill", h = "stop", i = "stroke", j = "stroke-width", k = "style", l = "none", m = "jsplumb_gradient_", n = "lineWidth", o = {svg: "http://www.w3.org/2000/svg", xhtml: "http://www.w3.org/1999/xhtml"}, p = function (a, b) {
        ...
        for (var p = 0; p < c.gradient.stops.length; p++) {
            var r = 1 == k.segment || 2 == k.segment ? p : c.gradient.stops.length - 1 - p, t = jsPlumbUtil.convertStyle(c.gradient.stops[r][1], !0), u = q(h, {offset: Math.floor(100 * c.gradient.stops[p][0]) + "%", "stop-color": t});
            n.appendChild(u)
        }
    ...
    var w = function (a) {
        ...
        return this.getDisplayElements = function () {
            ...
            if (null != b) {
                ...
                null != e && (e.xmin < 0 && (g[0] += e.xmin), e.ymin < 0 && (g[1] += e.ymin), h[0] = e.xmax + (e.xmin < 0 ? -e.xmin : 0), h[1] = e.ymax + (e.ymin < 0 ? -e.ymin : 0)), a.useDivWrapper ? (jsPlumbUtil.sizeElement(this.canvas, g[0], g[1], h[0], h[1]), g[0] = 0, g[1] = 0, f = r([0, 0])) : f = r([g[0], g[1]]), c.paint.apply(this, arguments), p(this.svg, {style: f, width: h[0], height: h[1]})
            }
        }, {renderer: c}
    };
    jsPlumbUtil.extend(w, jsPlumb.jsPlumbUIComponent, {cleanup: function () {
        ...
        c.renderer.paint = function (c, d, e) {
            ...
            if (e.xmin < 0 && (h[0] = -e.xmin), e.ymin < 0 && (h[1] = -e.ymin), f.length > 0) {
                ...
                var j = {d: g, transform: "translate(" + h[0] + "," + h[1] + ")", "pointer-events": a["pointer-events"] || "visibleStroke"}, k = null, l = [b.x, b.y, b.w, b.h], m = {mouseenter: function (a) {
    ...
    }, jsPlumbUtil.extend(jsPlumb.ConnectorRenderers.svg, w), jsPlumb.Segments.svg = {SegmentRenderer: {getPath: function (a) {
    ...
    jsPlumbUtil.extend(x, w, {reattachListeners: function () {
    ...
    var y = function (a, b) {
        a.apply(this, b), jsPlumb.jsPlumbUIComponent.apply(this, b), this.isAppendedAtTopLevel = !1, this.path = null, this.paint = function (a, d) {
            if (a.component.svg && d) {
                ...
                d.xmin < 0 && (f[0] = -d.xmin), d.ymin < 0 && (f[1] = -d.ymin), p(this.path, {d: c(a.d), "class": e, stroke: a.strokeStyle ? a.strokeStyle : null, fill: a.fillStyle ? a.fillStyle : null, transform: "translate(" + f[0] + "," + f[1] + ")"})
            }
        };
        var c = function (a) {
    ...
    jsPlumbUtil.extend(y, [jsPlumb.jsPlumbUIComponent, jsPlumb.Overlays.AbstractOverlay], {cleanup: function () {
        ...
        jsPlumb.Overlays.GuideLines.apply(this, arguments), this.paint = function (f, g) {
            ...
            var h = [0, 0];
            g.xmin < 0 && (h[0] = -g.xmin), g.ymin < 0 && (h[1] = -g.ymin), p(c, {d: e(f.head, f.tail), stroke: "red", fill: null, transform: "translate(" + h[0] + "," + h[1] + ")"}), p(a, {d: e(f.tailLine[0], f.tailLine[1]), stroke: "blue", fill: null, transform: "translate(" + h[0] + "," + h[1] + ")"}), p(b, {d: e(f.headLine[0], f.headLine[1]), stroke: "green", fill: null, transform: "translate(" + h[0] + "," + h[1] + ")"})
        };
        var e = function (a, b) {
    ...
    "use strict";
    var a = function (a, c) {
        var d = a[c ? "_internalKatavorio" : "_katavorio"], e = b(a);
        return d || (d = new Katavorio({bind: e.on, unbind: e.off, getSize: jsPlumb.getSize, getPosition: function (b) {
            var c = jsPlumbAdapter.getOffset(b, a);
            return[c.left, c.top]
        }, setPosition: function (a, b) {
            a.style.left = b[0] + "px", a.style.top = b[1] + "px"
        }, addClass: jsPlumbAdapter.addClass, removeClass: jsPlumbAdapter.removeClass, intersects: Biltong.intersects, indexOf: jsPlumbUtil.indexOf, css: {noSelect: a.dragSelectClass, droppable: "jsplumb-droppable", draggable: "jsplumb-draggable", drag: "jsplumb-drag", selected: "jsplumb-drag-selected", active: "jsplumb-drag-active", hover: "jsplumb-drag-hover"}}), a[c ? "_internalKatavorio" : "_katavorio"] = d, a.bind("zoom", d.setZoom)), d
    }, b = function (a) {
        var b = a._mottle;
    ...
    jsPlumb.extend(jsPlumbInstance.prototype, {getDOMElement: function (a) {
        ...
        a(this).elementRemoved(c), b(this).remove(c)
    }, doAnimate: function (a, b, d) {
        d = d || {};
        var e = jsPlumbAdapter.getOffset(a, this), f = c(e, b), g = f[0] - e.left, h = f[1] - e.top, i = d.duration || 250, j = 15, k = i / j, l = j / i * g, m = j / i * h, n = 0, o = setInterval(function () {
        ...
        a(this).destroyDraggable(b)
    }, destroyDroppable: function (b) {
        a(this).destroyDroppable(b)
    ...
    }, dragEvents: {start: "start", stop: "stop", drag: "drag", step: "step", over: "over", out: "out", drop: "drop", complete: "complete"}, animEvents: {step: "step", complete: "complete"}, stopDrag: function (a) {
        ...
        b(this).trigger(a, c, d)
    }, getOriginalEvent: function (a) {
        return a
    }, on: function () {
        b(this).on.apply(this, arguments)
    }, off: function () {
        b(this).off.apply(this, arguments)
    }});
    var d = function (a) {
        var b = function () {
            /complete|loaded|interactive/.test(document.readyState) && "1.6.2" != typeof document.body && null != document.body ? a() : setTimeout(b, 9)
        };
        b()
    };
    d(jsPlumb.init)
